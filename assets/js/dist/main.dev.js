...
$(function () {
  ...
  setInterval(function () {
    var value = $('.mySlick .slick-track').css('top').replace('px', '');
  ...
  links = _toConsumableArray($('nav ul li a'));
  ...
  $('.allItems.right').slick(sideOptionRight); // Main Slider Options 
  ...
  $('.my-slider .anim10').owlCarousel(ninethCarouselOptions); // last sliders
  ...
  $('.last-sliders .last-slider .anim434').owlCarousel($slider12); //nice scroll
